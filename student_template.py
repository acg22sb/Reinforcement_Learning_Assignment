...
def experiment_history_length(
    ...
    ax2.set_ylabel("Avg Turns (failed = max_turns + 1)")
...
def experiment_epsilon(
    ...
    ax2.set_ylabel("Avg Turns (failed = max_turns + 1)")
    ax2.set_title("Avg Turns vs Epsilon")
    ax2.legend()
    ax2.grid(True, alpha=0.3)
...
def experiment_learning_curves(
    ...
    ax1.plot(episodes, win_rate_mean * 100, label="Q-Learning (mean)")
    ax1.fill_between(
        episodes,
    ...
    ax2.plot(episodes, turns_mean, label="Q-Learning (mean)")
    ax2.fill_between(
        episodes,
    ...
    ax2.set_ylabel("Avg Turns (failed = max_turns + 1)")
    ax2.set_title("Learning Curve: Avg Turns")
    ax2.legend()
    ax2.grid(True, alpha=0.3)
